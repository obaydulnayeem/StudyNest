...
For the full list of se ttings and their values, see
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [ # order matters
                ...
                # 'context_processors.search_ctxp.search_ctxp',
                ...
                # 'apps.university.context_processors.semester_year_converter_context_processors.semester_year_converter',
